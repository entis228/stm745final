#ifndef __CALC_FLOAT_H
#define __CALC_FLOAT_H

//Calc.h
#include "Data.h"

//////////////////////////////////////////////
//Расчет линейного напряжения  Uab 
ValueAB_float CalcUab(Vector_float A_U, Vector_float B_U);
//////////////////////////////////////////////
//Расчет линейного напряжения  тока Iab
ValueAB_float CalcIab(Vector_float A_I, Vector_float B_I);
//////////////////////////////////////////////
//Расчет линейного напряжения  Ubc 
ValueBC_float CalcUbc(Vector_float B_U, Vector_float C_U);
//////////////////////////////////////////////
//Расчет линейного напряжения  тока Ibc
ValueBC_float CalcIbc(Vector_float B_I, Vector_float C_I);
//////////////////////////////////////////////
//Расчет линейного напряжения  Uca 
ValueCA_float CalcUca(Vector_float C_U, Vector_float A_U);
//////////////////////////////////////////////
//Расчет линейного напряжения  тока Ica
ValueCA_float CalcIca(Vector_float C_I, Vector_float A_I);
//////////////////////////////////////////////
